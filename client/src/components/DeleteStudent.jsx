export default function deleteStudent({ studentName, setNotVisible, submitFunction }) {
    return (
        <div className='p-8'>
            <h2 className='font-sora text-4xl font-extrabold'>Delete {studentName.firstName} {studentName.lastName}</h2>
            <div className='flex flex-col mt-8 pl-5'>
                <strong className='font-sora text-xl font-bold'>Are you sure you want to delete {studentName.firstName} {studentName.lastName}?</strong>
