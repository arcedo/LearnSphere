export default function ModifySkill() {
    ...
    return (
        <div className='p-8'>
            <h2 className='font-sora text-4xl font-extrabold'>Modify skill</h2>
            <div className="mt-5 mb-1 w-full flex items-center" >
            ...
            <div className='flex gap-3 justify-start items-center'>
                <button className='w-36 border-2 border-white rounded-md px-4 py-2 bgSidebar hover:bg-white hover:text-black transition-all'>
                    Add skill
                </button>
            </div>
        </div>
