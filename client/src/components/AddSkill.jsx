        ...
        <div className='p-8'>
            ...
            <div className='flex justify-around gap-5 pt-5 mb-5'>
                ...
                <div className="flex items-center mt-7">
                    <label onClick={handleImageClick} id='imageInputLabel' className="cursor-pointer w-36 text-center border-2 border-white rounded-md px-4 py-2 overflow-hidden bgSidebar bg-white hover:bg-white text-white hover:text-black transition-all">
